...
n_head = 6
n_layer = 6
dropout = 0.2 #essentially turn of 20% of nn randomly every pass
...
#tokenisation (at this stage this is a character level tokenisation)
...
class FeedForward(nn.Module):
    def __init__(self, n_embd):
        ...
        self.net = nn.Sequential(
            nn.Linear(n_embd,4 * n_embd), #4 here comes from the attention is all you need paper
            nn.ReLU(),
...
# create multiple blocks of self attention and feedforwards
