...
#below is a function to make the hellaswag dataset work the way we want for gpt2 training
...
# to launch this simply use python gpt2_train.py
# for ddp launch
# torchrun --standalone --nproc_per_node=8 gpt2_train.py (because we have 8 GPUs)
...
max_lr = 1.2e-3 # i am using a higher learning rate than Karpathy (he used 6e-4)
min_lr = max_lr * 0.1
warmup_steps = 715
